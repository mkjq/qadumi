      ...
      {loading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="rounded-3xl border border-white/10/80 bg-white/5/90 p-6 shadow-sm animate-pulse space-y-4"
            >
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5/80 p-8 text-center text-slate-400 text-sm">
              ...
              <motion.div
                ...
                className={`group relative flex flex-col justify-between rounded-3xl border p-6 backdrop-blur-md transition-all duration-300 ${
                  isUnlocked
                    ...
                    : 'border-white/10/80 bg-white/5/80 opacity-90 hover:opacity-100 hover:shadow-md'
                }`}
              >
                <div>
                  ...
                  {/* Title */}
                  <h3 className="text-base sm:text-lg font-black text-white mb-2 group-hover:text-navy-800 transition-colors">
                    {reward.title}
                  </h3>
                  ...
                  {!isUnlocked && (
                    <div className="mb-4 bg-gradient-to-b from-[#051124] via-[#091C3B] to-[#0A2246] rounded-xl p-2.5 border border-white/5">
                ...
                <div className="pt-2 border-t border-white/5">
                  {isUnlocked ? (
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-amber-500 via-amber-600 to-gold-600 px-4 py-3 text-xs sm:text-sm font-bold text-white shadow-md shadow-amber-500/20 transition-all hover:brightness-105 active:scale-[0.98]"
                    >
                    ...
                    <button
                      disabled
                      className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-white/10 px-4 py-3 text-xs sm:text-sm font-bold text-slate-400 cursor-not-allowed border border-white/10/60"
                    >
        ...
        {selectedReward && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
            <motion.div
              ...
              className="relative w-full max-w-md rounded-3xl bg-white/5 p-6 sm:p-8 shadow-2xl border border-white/10"
              dir="rtl"
            >
              {/* Close Button */}
              <button
              ...
              <div className="mb-6 rounded-2xl bg-amber-50/60 border border-amber-200/80 p-4">
                ...
                <div className="flex items-center justify-between text-xs pt-2 border-t border-amber-200/60">
                  <span className="text-slate-300 font-medium">تكلفة الاستبدال:</span>
                  <span className="font-black text-amber-700">
                    -{selectedReward.pointsCost} نقطة
                  </span>
                </div>
                <div className="flex items-center justify-between text-xs pt-1">
                  <span className="text-slate-300 font-medium">رصيدك المتبقي بعد الاستبدال:</span>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-amber-500 to-gold-600 py-3.5 px-4 text-xs sm:text-sm font-bold text-white shadow-md shadow-amber-500/20 transition hover:brightness-105 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isRedeeming ? (
                ...
                <button
                  onClick={handleCloseModal}
                  disabled={isRedeeming}
                  className="rounded-2xl border border-white/10 bg-white/5 px-5 py-3.5 text-xs sm:text-sm font-bold text-slate-700 shadow-sm transition hover:bg-gradient-to-b from-[#051124] via-[#091C3B] to-[#0A2246]"
                >
                  إلغاء
                </button>
              </div>
