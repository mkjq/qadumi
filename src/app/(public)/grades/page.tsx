      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        {filteredGrades.length === 0 ? (
          ...
          <div className="text-center py-20 max-w-md mx-auto">
            <div className="w-20 h-20 mx-auto mb-4 rounded-3xl bg-white/[0.05] border border-white/10 flex items-center justify-center text-slate-300">
              <Search className="w-8 h-8 text-cyan-400" />
            </div>
            <h3 className="text-xl font-bold text-white mb-2">لم نتمكن من العثور على أي صف</h3>
                  ...
                  <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8 pb-4 border-b border-white/10">
                    <div>
                      <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-bold mb-2.5 border shadow-sm backdrop-blur-md bg-white/[0.06] border-white/15">
                        ...
                        <span className="text-white">{config.badge}</span>
                      </div>
                      <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight flex items-center gap-3">
                        <span>{config.name}</span>
                        <span className="text-xs sm:text-sm font-bold px-2.5 py-0.5 rounded-full bg-white/10 text-slate-200 border border-white/10">
                          {grades.length} صفوف
                        </span>
                      </h2>
                    ...
                    <div className="text-xs sm:text-sm font-semibold text-slate-300 bg-white/[0.05] border border-white/10 px-3.5 py-1.5 rounded-xl self-start md:self-auto">
                      {config.subtitle}
                    </div>
                  </div>
                        ...
                        >
                          ...
                          >
                            ...
                            <div>
                              ...
                              <div className="flex items-center justify-between gap-3 mb-4">
                                <div className="flex items-center gap-3">
                                  <div
                                    ...
                                    } text-white shrink-0 border border-white/20 group-hover:scale-105 group-hover:-rotate-2 transition-transform duration-300`}
                                  >
                                    {grade.numeral}
                                  </div>
                                  <div>
                              ...
                              {/* Title */}
                              <h3 className="text-xl font-black text-white group-hover:text-cyan-300 transition-colors leading-tight mb-2">
                                {grade.name}
                              </h3>

                              {/* Description */}
                              <p className="text-xs sm:text-sm text-slate-300/90 leading-relaxed mb-5 line-clamp-2">
                                {grade.description}
                              </p>
                              ...
                              <div className="mb-6">
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                  {grade.subjects.slice(0, 3).map((sub) => (
                                    <span
                                      key={sub.id}
                                      className="text-[11px] font-medium px-2.5 py-1 rounded-lg bg-white/[0.06] hover:bg-white/[0.12] border border-white/10 text-slate-200 transition-colors"
                                    >
                                      {sub.name}
                                    </span>
                                  ))}
                            ...
                            <div className="pt-4 border-t border-white/[0.08] mt-2">
                              ...
                              <div className="grid grid-cols-3 gap-2 text-xs mb-4">
                                <div className="flex items-center gap-1.5 text-slate-300">
                                  ...
                                  <span className="truncate">
                                    <strong className="text-white font-bold">{grade.subjects.length}</strong> مواد
                                  </span>
                                </div>
                                <div className="flex items-center gap-1.5 text-slate-300">
                              ...
                              <div className="flex items-center justify-between pt-1">
                                ...
                                <div
                                  className={`w-8 h-8 rounded-xl bg-white/[0.06] border border-white/10 flex items-center justify-center text-slate-300 ${theme.actionButtonHover} group-hover:border-transparent transition-all duration-300 shadow-sm`}
                                >
        ...
        {/* ============================================================ */}
        <section className="mt-24 p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-slate-900/90 via-[#071938]/90 to-indigo-950/90 text-white relative overflow-hidden shadow-2xl border border-white/15 backdrop-blur-xl">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0 w-full sm:w-auto">
              ...
              <Link
                href="/teachers"
                className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-white/10 hover:bg-white/15 text-white font-semibold text-sm text-center backdrop-blur border border-white/15 transition-all"
              >
                تصفح كادر المعلمين
              </Link>
            </div>
